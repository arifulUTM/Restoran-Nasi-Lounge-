...
<?php include "header.php"; ?>	
	...
	<div id="slides" class="cover-slides">
		<ul class="slides-container">
			<li class="text-left">
				<img src="images/malaysian food/1.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Restoran Nasi Lounge</strong></h1>
							<p class="m-b-40">Have It Your Way,   <br> 
							We have a list of favorite foods and supplies on campus for UTM students.</p>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<p class="m-b-40">We have local Malaysian food including Arabian South Asian food. We have a special focus on Arabian food for international students 
<br> 
							</p>
			...
			<li class="text-left">
				<img src="images/malaysian food/nasi lemak.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Restoran Nasi Lounge</strong></h1>
							<p class="m-b-40">We have local Malaysian food including Arabian South Asian food. We have a special focus on Arabian food for international students</p>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>Restoran Nasi Lounge</span></h1>
						<h4>Little Story</h4>
						<p>Our journey started in 2022, we are just managing our service at UTM. 
 </p>
						<p>Quick Bites in Skudai, Quick Bites near me, Quick Bites in Taman University</p>
						<a class="btn btn-lg btn-circle btn-outline-new-white" href="#">Contact Us</a>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12">
					<img src="images/malaysian food/arked.jpg"  width="200%" height="200%" class="img-fluid">
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row inner-menu-box">
				<div class="col-3">
					<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						...
						<a class="nav-link" id="v-pills-tava-tab" data-toggle="pill" href="#v-pills-tava" role="tab" aria-controls="v-pills-tava" aria-selected="false">Weekend Speical</a>
					</div>
				</div>
